    ...
    _createClass(Cascader, [{
        ...
        value: function getCols() {
            ...
            return childrenTree.map(function () {
                ...
                return React.createElement(Picker, { key: level, prefixCls: pickerPrefixCls, style: { flex: 1 } }, children.map(function (item) {
        ...
        value: function render() {
            ...
            return React.createElement(MultiPicker, { style: multiStyle, prefixCls: prefixCls, disabled: disabled, className: className, selectedValue: this.state.value, rootNativeProps: rootNativeProps, indicatorStyle: indicatorStyle, pickerItemStyle: pickerItemStyle, onValueChange: this.onValueChange }, cols);
        }
    }]);
